...
"""
N = abs(int(input('Введите число 0 если играете на английской раскладке. 1 если на русской раскладке:')))
...
if N == 0:
	print('За ваше слово вы получаете', sum([k for i in word for k, v in eng_dic.items() if i in v]), 'очков')
elif N == 1:
	print('За ваше слово вы получаете', sum([k for i in word for k, v in rus_dic.items() if i in v]), 'очков')
